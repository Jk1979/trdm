<div class="row">
    ...
    <div class="col-md-3">
        <div id="main_icon">
        <?php if($product['brand_id'] == 89 ):?>
        <img src="/public/img/freeKiev.jpg" title="Бесплатная доставка по Киеву." style="display: block;">
        <?php endif;?>
     ...
     <div class="col-md-5">
         ...
         <p id="avail"  data-code="<?=$product['code']?>" style="cursor:pointer;<?php if($product['brand_id'] != false ):?>display:none;<?php endif;?>">
         Проверить наличие
         </p>
