<center>
<h2 style="color:red">В настоящее время регистрация пользователей не проводится .</h2>
<br/>
<?php if($errors):?>
...
<table width="300" cellspacing="5">
    ...
    <tr>
        <td colspan="2" align="center"><?=Form::submit('submit', 'Зарегистрироваться', array('disabled'=>'disabled'))?></td>
    </tr>
</table>
<?=Form::close()?>*/ ?>
</center>