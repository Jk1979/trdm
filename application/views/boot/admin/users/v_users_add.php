...
<table width="300" cellspacing="5">
    ...
    <tr>
     ...
     <tr>
        ...
        <td><?=Form::password('password', $data['password'], array('size' => 20, 'required' => 'required', 'placeholder'=> 'Введите пароль'))?></td>
    </tr>
     <tr>
        <td ><?=Form::label('password_confirm', 'Повторить пароль')?>:</td>
        <td><?=Form::password('password_confirm', $data['password_confirm'], array('size' => 20, 'required' => 'required', 'placeholder'=> 'Повторите пароль'))?></td>
    </tr>
    <tr>
        <td colspan="2" align="center"><?=Form::submit('add', 'Добавить пользователя')?></td>
    </tr>
</table>
<?=Form::close()?>
